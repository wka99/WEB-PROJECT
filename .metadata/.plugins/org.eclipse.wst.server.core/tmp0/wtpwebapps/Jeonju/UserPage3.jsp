...
$(document).ready(function(){
	...
	sql5="select like_check from likes where postnum="+number_like;
	if (number_like!=null){
    ...
    $("#searchbutton").click(function(event){
    	...
    	window.location.href=encodeURI("UserPage3.jsp?search="+keyword);
    });
    $('.like').click(function(){
    	var num=$(this).attr("id");
    	window.location.href=encodeURI("UserPage3.jsp?number_like="+num);
    });
    $('.star').click(function(){
    	var num=$(this).attr("id");
    	window.location.href=encodeURI("UserPage3.jsp?number_star="+num);
    });
